...
var ball = Bodies.polygon(170, 390, 25, 25, {restitution: 0.9, mass:5})
...
var wall4 = Bodies.rectangle(760, 430, 50, 150, {isStatic:true})
...
var tunnelRight = Bodies.rectangle(2400, 2420, 15, 3200, {isStatic:true, mass: 1})
...
function fireCannon(){
    console.log("fired")
    Body.applyForce(ball, ball.position, {x: .35, y:-.35})
    followCamera(ball)
}
